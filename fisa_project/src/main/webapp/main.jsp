...
<body>
	...
	<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left"
		...
		<a href="#food" onclick="w3_close()" class="w3-bar-item w3-button">하의</a>
		<a href="#about" onclick="w3_close()" class="w3-bar-item w3-button">신발</a>
	</nav>
	...
	<div class="w3-top">
		<div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
			...
			<div class="w3-center w3-padding-16">상품 응모 사이트</div>
		</div>
	</div>
	...
	<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
		...
		<% if (session == null) { %>
			<!-- 버튼 추가 -->
			<a href="#dataView" id="login">
			<button style="font-size:15px" onClick="location.href='login.html'">로그인</button>
		</a>
		<% } else { %>
			<!-- 로그인되었을 때는 버튼을 숨김 -->
		...
		<div class="w3-row-padding w3-padding-16 w3-center" id="food">
			<div class="w3-quarter">
				...
				<a href="#dataView" id="btn">
					<button style="font-size:10px">응모하기</button>
				</a>
			</div>
			<div class="w3-quarter">
